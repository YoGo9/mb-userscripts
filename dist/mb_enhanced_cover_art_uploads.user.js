...
// @match        *://harmony.pulsewidth.org.uk/*
...
(function () {
  ...
  function addSeedLinksToCovers(mbids, origin) {
  ...
  function addSeedLinkToCover(coverElement, mbids, origin) {
      const img = qs('img', coverElement);
      const imgUrl = img.src.replace(/\/250x250bb\.jpg/, '/1000x1000bb.jpg');
      ...
      for (const mbid of mbids) {
          ...
          const link = function () {
              var $$a = document.createElement('span');
              $$a.setAttribute('class', 'label add-cover-art-link');
              $$a.addEventListener('click', () => window.open(seedUrl, '_blank'));
